...
import { OnSaleCollectible } from "../page";
...
export const NFTCardOnSale = ({ nft }: { nft: OnSaleCollectible }) => {
  ...
  const handlePurchaseNft = async () => {
    try {
      ...
      await writeContractAsync({ functionName: "purchaseNft", args: [BigInt(nft.tokenId)], value: parseEther(nft.price) });
    ...
    <div className="card bg-base-100 shadow-lg w-[280px] border border-accent/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="card-body p-5 space-y-2">
        ...
        <div className="flex justify-between text-sm">
          <span className="text-base-content">卖家</span>
